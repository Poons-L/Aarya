    ...
    <div className="h-full bg-white flex flex-col">
      ...
      <div className="flex-1 px-8 py-12 overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 py-3 border-2 border-slate-200 rounded-xl font-medium text-slate-700 active:bg-slate-50 transition-colors"
          >
