...
import { ArrowLeft, Users, Search, Mail, Shield, Activity, UserX, ChevronUp, ChevronDown } from 'lucide-react';
    ...
    return (
      <div className="h-full flex items-center justify-center bg-slate-50 p-6">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 max-w-sm w-full text-center">
          ...
          <button
            onClick={onBack}
            className="px-5 py-2 bg-orange-500 text-white rounded-lg text-sm font-medium"
          >
            Go Back
          </button>
        </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-slate-50 text-left">
                    <th
                      className="py-2.5 px-3 font-medium text-slate-600 cursor-pointer hover:text-slate-900 whitespace-nowrap"
                    ...
                    <th
                      className="py-2.5 px-3 font-medium text-slate-600 cursor-pointer hover:text-slate-900 whitespace-nowrap"
                      onClick={() => handleSort('signup_method')}
                    >
                    ...
                    <th
                      className="py-2.5 px-3 font-medium text-slate-600 cursor-pointer hover:text-slate-900 whitespace-nowrap text-center"
